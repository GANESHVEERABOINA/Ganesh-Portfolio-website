        ...
        <div className="w-full px-6 md:px-12 lg:px-20 flex flex-col-reverse md:flex-row items-center justify-between gap-12 mt-10 md:mt-0">
          <div className="w-full md:w-1/2 space-y-6 z-10 text-center md:text-left">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} className="flex gap-4 justify-center md:justify-start pt-2">
              ...
              <a href="https://github.com/YOUR_USERNAME" target="_blank" rel="noreferrer" className="bg-white/10 backdrop-blur-md border border-white/20 text-white p-3 rounded-full hover:scale-110 hover:bg-white/20 transition-all shadow-lg"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"></path><path d="M9 18c-4.51 2-5-2-7-2"></path></svg></a>
              <a href="mailto:ganesh.veeraboina@example.com" target="_blank" rel="noreferrer" className="bg-white/10 backdrop-blur-md border border-white/20 text-white p-3 rounded-full hover:scale-110 hover:bg-white/20 transition-all shadow-lg"><Mail size={20} strokeWidth={2.5} /></a>
            </motion.div>
      ...
      <footer id="contact" className="bg-black py-16 mt-20 relative">
        ...
        <div className="w-full px-6 md:px-12 lg:px-20 text-center">
          ...
          <div className="flex justify-center gap-6 mb-12">
            <a href="mailto:ganesh.veeraboina@example.com" className="bg-white/5 backdrop-blur-md border border-white/10 text-white hover:bg-white/10 hover:border-white/40 hover:scale-110 p-4 rounded-full shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all"><Mail size={24} /></a>
            <a href="https://github.com/YOUR_USERNAME" className="bg-white/5 backdrop-blur-md border border-white/10 text-white hover:bg-white/10 hover:border-white/40 hover:scale-110 p-4 rounded-full shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"></path><path d="M9 18c-4.51 2-5-2-7-2"></path></svg></a>
